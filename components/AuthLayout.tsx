  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:block relative flex-1 w-0 overflow-hidden bg-slate-900">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/60 to-indigo-900/40"></div>
        ...
        <div className="absolute bottom-0 left-0 w-full p-20 text-white z-20">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-indigo-200 text-sm">Master 2 Droit des Affaires, Sorbonne</div>
            </div>
          </div>
        </div>
      </div>
