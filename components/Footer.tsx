  ...
  return (
    <footer className="bg-emerald-950 text-white pt-20 pb-10 border-t border-emerald-900">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-2xl font-serif font-bold text-white tracking-tight">MémoirePro</span>
            </div>
            ...
            <div className="flex gap-4">
              <a href="#" className="text-emerald-400 hover:text-white transition-colors transform hover:scale-110"><Linkedin size={20} /></a>
              <a href="#" className="text-emerald-400 hover:text-white transition-colors transform hover:scale-110"><Twitter size={20} /></a>
              <a href="#" className="text-emerald-400 hover:text-white transition-colors transform hover:scale-110"><Instagram size={20} /></a>
            </div>
          </div>
        ...
        <div className="border-t border-emerald-800/50 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-emerald-300/60">
          <p>&copy; {new Date().getFullYear()} MémoirePro AI. Tous droits réservés.</p>
